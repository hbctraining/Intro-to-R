...
>
> `dplyr` is part of the [tidyverse suite of packages](http://tidyverse.org), which were designed to work together to quickly and easily perform the most common operations needed for data science. We have [materials available](tidyverse_data_wrangling.md) to learn about some convenient functions available from these tools.
